...
benchmark problem mainly uses a single data structure. If the size of this data
structure is, say, 4 words, eliminating the one-word pointer would yield a saving
of \nicefrac{1}{4}.
